...
public class Point {
    ...
    public boolean equals(Object other) {
        ...
        if (!result && other instanceof Point) {
    ...
    public static List<Point> getPoints(float a, float b, float c, float d, float e) {
        ...
        for (Point point : temp) {
            ...
            if (value > e - 0.01f && value < e + 0.01f) {
                output.add(point);
            }
        }
        return new ArrayList<>(new LinkedHashSet<>(output));
    }
